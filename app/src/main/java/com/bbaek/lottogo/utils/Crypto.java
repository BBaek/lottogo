...
/**
 * Created by woonsungbaek on 2015. 11. 16..
 */
public class Crypto
{
    ...
    {
        private static String getAESKey() throws NoSuchPaddingException, InvalidAlgorithmParameterException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, InvalidParameterSpecException {
            ...
            String key = Crypto.Utils.pbkdf2("Secret Passphrase", salt, 1000, keySizeInBytes);

            return key;
        }

        public static String getAESEncryptText(String plainText) throws NoSuchPaddingException, InvalidKeyException, NoSuchAlgorithmException, NoSuchProviderException, InvalidAlgorithmParameterException, InvalidParameterSpecException, UnsupportedEncodingException, IllegalBlockSizeException, BadPaddingException {
            /*** encrypt */
            ...
            return aes.encrypt(plainText, getAESKey());
        }

        public static String getAESDecryptText(String cipherText) throws NoSuchPaddingException, InvalidKeyException, NoSuchAlgorithmException, NoSuchProviderException, InvalidAlgorithmParameterException, InvalidParameterSpecException, UnsupportedEncodingException, IllegalBlockSizeException, BadPaddingException {
            /*** decrypt */
            Crypto _c = new Crypto();
            Crypto.AES aes = _c.new AES();
            ...
            return aes.decrypt(cipherText, getAESKey());
        }
